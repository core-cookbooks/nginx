...
case node['platform_family']
  when 'rhel', 'fedora', 'suse','arch'
	default['nginx']['conflict']['file_path'] = '/etc/init.d/httpd'
	default['nginx']['conflict']['package'] = 'httpd'
  when 'debian'
	default['nginx']['conflict']['file_path'] = '/etc/init.d/apache2'
	default['nginx']['conflict']['package'] = 'apache2'
end
